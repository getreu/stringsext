...
* Binaries and packages (usually built from latest commit):
  ...
  - Package for Debian 10 Buster:
    ...
    [x86_64-unknown-linux-gnu/debian/stringsext_2.3.4_amd64.deb](https://blog.getreu.net/projects/stringsext/_downloads/x86_64-unknown-linux-gnu/debian/stringsext_2.3.4_amd64.deb)
